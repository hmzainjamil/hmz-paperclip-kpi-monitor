...
> Paperclip KPI monitor — real-time metrics tracking, anomaly detection, threshold alerts, Slack notifications, automated performance reports.
...
|---|---|---|
| [Paperclip-Kpi-Monitor Core](bin/) | `bin/` | Primary automation scripts and tools for hmz-paperclip-kpi-monitor |
