...
> Paperclip KPI monitor — real-time metrics tracking, anomaly detection, threshold alerts, Slack notifications, and automated performance reports.
...
|---|---|---|
| [Core System](bin/) | `bin/` | All automation scripts for hmz-paperclip-kpi-monitor — MAE integrated |
